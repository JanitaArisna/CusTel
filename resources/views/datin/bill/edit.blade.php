...
<div class="my-3 p-3 bg-body rounded shadow-sm">
    ...
    <form action="{{ route('bill.update', ['acc_num' => $acc_num, 'sid' => $bill->sid, 'tahun' => $bill->tahun]) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('bill.show', ['acc_num' => $acc_num, 'sid' => $sid]) }}" class="btn btn-danger">Cancel</a>
    </form>
</div>

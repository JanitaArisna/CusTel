<x-app-layout>
    ...
    <div class="container-fluid my-3 p-3 bg-body rounded shadow-sm">
        <!-- Title -->
        <h3 class="mb-2">ENTERPRISE SERVICE DETAILS</h3>
        <h2 class="text-xs text-gray-400 mb-4">Manager: {{ $dataEnterprise }}</h5>
        ...
        <!-- Tombol Back -->
        <button type="button" class="btn btn-outline-primary mt-3" onclick="window.location.href = '{{ route('enterprise') }}'">
            Back
        </button>
    </div>
</x-app-layout>
